...
def test_rate_thick_binary_kappa_candidate_lean_surface():
    ...
    assert "binaryKappaCandidate_pos" in lean
    assert "binaryKappaPositiveTarget_proved" in lean
...
def test_rate_thick_binary_kappa_candidate_boundary():
    ...
    assert "Binary kappa positivity proved under `BinaryKappaAdmissible λ`." in doc
