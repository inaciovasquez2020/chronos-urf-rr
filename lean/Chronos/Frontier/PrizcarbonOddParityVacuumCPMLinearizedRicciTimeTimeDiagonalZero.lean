...
theorem
  ...
  rfl
/--
The Schwarzschild background connection kernel with radial, radial, and theta
indices vanishes:

`K̄_{rrθ} = 0`.

Both radial derivatives of the off-diagonal `rθ` metric component vanish, and
the theta derivative of the diagonal radial-radial metric component vanishes.
No perturbation identity, harmonic equation, vacuum equation, product-rule
reduction, or master residual is used.
-/
theorem
    prizcarbonOddParityVacuumCPMLinearizedRicciRadialAngularPrincipalDerivativeRadialSecondConnectionDerivativeThetaBackgroundConnectionKernelRadialRadialTheta_eq_zero
    (frame : ReggeWheelerSchwarzschildStaticDetectorFrame) :
    reggeWheelerSchwarzschildConnectionKernel
        frame
        .radial
...
connection-kernel factor `K̄_{rrθ}` is zero. The remaining three terms are
...
/--
Every angular coordinate partial of the off-diagonal Schwarzschild inverse
metric component `ḡ^{rθ}` vanishes:

`∂ₐ ḡ^{rθ} = 0`.

The background inverse metric is diagonal, and its derivative table has no
off-diagonal radial-theta entry. No perturbation identity, harmonic equation,
vacuum equation, product-rule reduction, or master residual is used.
-/
theorem
    prizcarbonOddParityVacuumCPMLinearizedRicciRadialAngularPrincipalDerivativeRadialSecondConnectionDerivativeThetaBackgroundInverseMetricRadialThetaAngularPartialFactor_eq_zero
    (frame : ReggeWheelerSchwarzschildStaticDetectorFrame)
    (angular : ReggeWheelerAngularCoordinate) :
    reggeWheelerSchwarzschildInverseMetricComponentPartial
        frame
...
Product-rule term 3 vanishes because its off-diagonal Schwarzschild inverse
metric angular-partial factor `∂ₐ ḡ^{rθ}` is zero. Product-rule term 4 is
preserved exactly and is not unfolded, simplified, canceled, factored, or
asserted to vanish.
...
-/
theorem
    prizcarbonOddParityVacuumCPMLinearizedRicciRadialAngularPrincipalDerivativeRadialSecondConnectionDerivativeThetaInverseMetricSummand_eq_fourthProductRuleTerm
    (frame : ReggeWheelerSchwarzschildStaticDetectorFrame)
    (cpmJet : ReggeWheelerOddParityVacuumCPMThirdJet)
    (harmonicJet : ReggeWheelerOddParityVectorHarmonicCoordinateSecondJet)
    (angular : ReggeWheelerAngularCoordinate) :
...
/--
The off-diagonal Schwarzschild inverse metric component with radial and theta
indices vanishes:

`ḡ^{rθ} = 0`.

This follows directly from the diagonal background inverse-metric definition.
No perturbation identity, harmonic equation, vacuum equation, product-rule
reduction, or master residual is used.
-/
theorem
    prizcarbonOddParityVacuumCPMLinearizedRicciRadialAngularPrincipalDerivativeRadialSecondConnectionDerivativeThetaBackgroundInverseMetricRadialThetaValueFactor_eq_zero
    (frame : ReggeWheelerSchwarzschildStaticDetectorFrame) :
    reggeWheelerSchwarzschildInverseMetricComponent
        frame
        .radial
...
and the off-diagonal Schwarzschild inverse-metric factor `ḡ^{rθ}` has been
proved zero. The perturbation-kernel partial factor is retained and is not
evaluated.
...
No factor is evaluated and no term is simplified, canceled, combined,
factored, or asserted to vanish. The time, radial, and theta inverse-metric
summands remain proved zero and unchanged.
-/
theorem
...
/--
Every angular coordinate partial of the Schwarzschild background connection
kernel with radial, radial, and phi indices vanishes:

`∂ₐ K̄_{rrφ} = 0`.

The two terms differentiating the off-diagonal `rφ` metric component vanish,
and the remaining angular second partial of the diagonal radial-radial metric
component vanishes for either angular derivative coordinate.
...
-/
theorem
    prizcarbonOddParityVacuumCPMLinearizedRicciRadialAngularPrincipalDerivativeRadialSecondConnectionDerivativePhiBackgroundConnectionKernelRadialRadialPhiAngularPartial_eq_zero
    (frame : ReggeWheelerSchwarzschildStaticDetectorFrame)
    (angular : ReggeWheelerAngularCoordinate) :
    reggeWheelerSchwarzschildConnectionKernelPartial
        frame
...
Product-rule term 2 vanishes because its Schwarzschild background
connection-kernel angular-partial factor `∂ₐ K̄_{rrφ}` is zero. Product-rule
terms 3 and 4 are preserved exactly and are not unfolded, simplified,
canceled, combined, factored, or asserted to vanish.
...
-/
theorem
    prizcarbonOddParityVacuumCPMLinearizedRicciRadialAngularPrincipalDerivativeRadialSecondConnectionDerivativePhiInverseMetricSummand_eq_thirdAndFourthProductRuleTerms
    (frame : ReggeWheelerSchwarzschildStaticDetectorFrame)
    (cpmJet : ReggeWheelerOddParityVacuumCPMThirdJet)
    (harmonicJet : ReggeWheelerOddParityVectorHarmonicCoordinateSecondJet)
    (angular : ReggeWheelerAngularCoordinate) :
...
/--
Every angular coordinate partial of the off-diagonal Schwarzschild inverse
metric component with radial and phi indices vanishes:

`∂ₐ ḡ^{rφ} = 0`.

This is a direct coordinate consequence of the diagonal Schwarzschild
background inverse metric and its explicitly defined coordinate partials.
No perturbation identity, harmonic equation, vacuum equation, product-rule
reduction, or master residual is used.
-/
theorem
    prizcarbonOddParityVacuumCPMLinearizedRicciRadialAngularPrincipalDerivativeRadialSecondConnectionDerivativePhiBackgroundInverseMetricRadialPhiAngularPartialFactor_eq_zero
    (frame : ReggeWheelerSchwarzschildStaticDetectorFrame)
    (angular : ReggeWheelerAngularCoordinate) :
    reggeWheelerSchwarzschildInverseMetricComponentPartial
        frame
...
Product-rule term 3 vanishes because its Schwarzschild background inverse-metric
angular-partial factor `∂ₐ ḡ^{rφ}` is zero. Product-rule term 4 is preserved
exactly and its perturbation-kernel partial factor is not evaluated.
...
-/
theorem
    prizcarbonOddParityVacuumCPMLinearizedRicciRadialAngularPrincipalDerivativeRadialSecondConnectionDerivativePhiInverseMetricSummand_eq_fourthProductRuleTerm
    (frame : ReggeWheelerSchwarzschildStaticDetectorFrame)
    (cpmJet : ReggeWheelerOddParityVacuumCPMThirdJet)
    (harmonicJet : ReggeWheelerOddParityVectorHarmonicCoordinateSecondJet)
    (angular : ReggeWheelerAngularCoordinate) :
...
/--
The off-diagonal Schwarzschild inverse metric component with radial and phi
indices vanishes:
...
-/
theorem
    prizcarbonOddParityVacuumCPMLinearizedRicciRadialAngularPrincipalDerivativeRadialSecondConnectionDerivativePhiBackgroundInverseMetricRadialPhiValueFactor_eq_zero
    (frame : ReggeWheelerSchwarzschildStaticDetectorFrame) :
    reggeWheelerSchwarzschildInverseMetricComponent
        frame
        .radial
...
and the off-diagonal Schwarzschild inverse-metric factor `ḡ^{rφ}` has been
proved zero. The perturbation-kernel partial factor is retained and is not
evaluated.
...
Ricci derivative equals the retained explicit first-connection derivative
angular cases.

The prior decomposition subtracts the retained second radial connection
derivative. That complete derivative has now been proved zero, so this theorem
performs only its substitution and removes the resulting subtraction by zero.

No new tensor component is expanded. No harmonic eigenvalue, vacuum equation,
connection-product reduction, or master residual is used.
-/
theorem
