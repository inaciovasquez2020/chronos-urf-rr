...
ARTIFACT = ROOT / "artifacts/status/qk_dini_shell_comparability_target_2026_06_09.json"
DOC = ROOT / "docs/status/QK_DINI_SHELL_COMPARABILITY_TARGET_2026_06_09.md"
REQUIRED_OBJECT = "QKDiniShellComparability"
...
def main() -> None:
    ...
    print("QK_DINI_SHELL_COMPARABILITY_TARGET_OK")
