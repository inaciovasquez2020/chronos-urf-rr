# WEC Preservation Under Time Evolution Target

Status: `OPEN_TARGET_NO_WEC_PRESERVATION_PROVED`

Object: `WEC_PRESERVATION_UNDER_TIME_EVOLUTION`
...
- `UNCONDITIONAL_STRESS_ENERGY_EVOLUTION_IDENTITY_NOT_PROVED`
- `POINTWISE_POSITIVITY_DOES_NOT_IMPLY_DYNAMICAL_PRESERVATION`
- `SOLUTION_REGULARITY_INTERVAL_NOT_ESTABLISHED`

## Next admissible object

`UNCONDITIONAL_STRESS_ENERGY_EVOLUTION_IDENTITY`

## Boundary

This is a frontier target only.
