...
Status: **ACTIVE_CONDITIONAL_FRONTIER**

Scope:

Conditional Chronos/EntropyDepth frontier artifact. No unconditional complexity lower bound or theorem-level closure is claimed.
