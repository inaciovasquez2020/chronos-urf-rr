...
\]
for every non-root vertex \(v\) in theorem scope.

Then every admissible rooted ball in the Newstein quotient-gap regime trivializes along the canonical parent chain.
