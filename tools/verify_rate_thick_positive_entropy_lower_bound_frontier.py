...
lean_path = root / "lean/Chronos/Frontier/RateThickPositiveEntropyLowerBoundFrontier.lean"
artifact_path = root / "artifacts/chronos/rate_thick_positive_entropy_lower_bound_frontier_2026_05_17.json"
status_path = root / "docs/status/RATE_THICK_POSITIVE_ENTROPY_LOWER_BOUND_FRONTIER_2026_05_17.md"
...
for token in [
    "FRONTIER_OPEN",
    "RateThickRankRateNonNullWitness",
    "RateThickFiberCoercivity",
    "RateThickPositiveEntropyLowerBound",
    "rateThickPositiveEntropyLowerBound_from_witness_and_coercivity",
...
for token in [
    ...
    "RateThickPositiveEntropyLowerBound",
    "RateThickFiberCoercivity",
    "no proof of RateThickPositiveEntropyLowerBound",
    "no unrestricted UniversalFiberEntropyGap"
]:
    assert token in artifact_text, token

forbidden = [
    "RateThickPositiveEntropyLowerBound is proved",
...
print("RateThickPositiveEntropyLowerBound frontier verified.")
