...
lean = ROOT / "lean/Chronos/Frontier/FiniteSupportRestrictedBoundaryLock.lean"
doc = ROOT / "docs/status/FINITE_SUPPORT_RESTRICTED_BOUNDARY_LOCK_2026_05_18.md"
artifact = ROOT / "artifacts/chronos/finite_support_restricted_boundary_lock_2026_05_18.json"
...
if data["status"] != "FINITE_SUPPORT_RESTRICTED_BOUNDARY_LOCK_CLOSED_ONLY":
    raise SystemExit("wrong artifact status")

if data["lean_theorem"] != "FiniteSupportRestrictedBoundaryLock_from_UFEG":
...
print("Finite-support restricted boundary lock verified.")
