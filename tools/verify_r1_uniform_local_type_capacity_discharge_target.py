...
ARTIFACT = ROOT / "artifacts/chronos/r1_uniform_local_type_capacity_discharge_target_2026_06_15.json"
CONTRACT_FILE = ROOT / "lean/Chronos/Frontier/R1ConcreteNewsteinFGLToNativeMapInputContract.lean"
LEAN_SURFACE = ROOT / "lean/Chronos/Frontier/R1UniformLocalTypeCapacityDischargeTarget.lean"
IMPORT_ROOT = ROOT / "lean/Chronos.lean"

EXPECTED = {
    "artifact": "R1_UNIFORM_LOCAL_TYPE_CAPACITY_DISCHARGE_TARGET",
    "date": "2026-06-15",
    "repository": "chronos-urf-rr",
    "status": "field_discharge_target",
    "target_field": "r1UniformLocalTypeCapacity",
    ...
    "lean_surface": "lean/Chronos/Frontier/R1UniformLocalTypeCapacityDischargeTarget.lean",
    "next_missing_object": "non-vacuous proof of uniform local-type capacity for the concrete Newstein/FGL source object",
    "boundary": "NO_DISCHARGED_R1_UNIFORM_LOCAL_TYPE_CAPACITY_FOR_CONCRETE_NEWSTEIN_FGL_SOURCE_OBJECT",
    "verifier": "tools/verify_r1_uniform_local_type_capacity_discharge_target.py",
    "test": "tests/test_r1_uniform_local_type_capacity_discharge_target.py",
}
...
REQUIRED_LEAN_DECLARATIONS = [
    ...
    "r1_uniform_local_type_capacity_discharge_target_boundary",
]
...
REQUIRED_NON_CLAIMS = [
    "does not discharge r1UniformLocalTypeCapacity",
...
FORBIDDEN_LEAN_FRAGMENTS = [
    "theorem r1_uniform_local_type_capacity_discharge",
...
def main() -> None:
    ...
    require(
        "import Chronos.Frontier.R1UniformLocalTypeCapacityDischargeTarget" in import_text,
        "missing Chronos root import",
    )

    print("R1_UNIFORM_LOCAL_TYPE_CAPACITY_DISCHARGE_TARGET_OK")
