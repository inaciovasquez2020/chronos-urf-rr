...
lean = ROOT / "lean/Chronos/Frontier/FiniteSupportRestrictedClayBoundaryStatusLock.lean"
doc = ROOT / "docs/status/FINITE_SUPPORT_RESTRICTED_CLAY_BOUNDARY_STATUS_LOCK_2026_05_18.md"
artifact = ROOT / "artifacts/chronos/finite_support_restricted_clay_boundary_status_lock_2026_05_18.json"
...
if data["status"] != "FINITE_SUPPORT_RESTRICTED_CLAY_BOUNDARY_STATUS_LOCK_CLOSED_ONLY":
    raise SystemExit("wrong artifact status")

if data["lean_theorem"] != "FiniteSupportRestrictedClayBoundaryStatusLock_from_UFEG":
...
print("Finite-support restricted Clay boundary status lock verified.")
