...
LEAN = ROOT / "lean/Chronos/Frontier/AdmissiblePNPBoundaryLockToClayBoundaryLock.lean"
CHRONOS = ROOT / "lean/Chronos.lean"
DOC = ROOT / "docs/status/ADMISSIBLE_PNP_BOUNDARY_LOCK_TO_CLAY_BOUNDARY_LOCK_2026_05_18.md"
ARTIFACT = ROOT / "artifacts/chronos/admissible_pnp_boundary_lock_to_clay_boundary_lock_2026_05_18.json"
...
required_lean_tokens = [
    ...
    "inductive ClayStatus",
    "| frontier_open",
    "structure ClayBoundaryLockTarget",
    ...
    "def AdmissiblePNPBoundaryLockToClayBoundaryLock",
    "theorem AdmissiblePNPBoundaryLockToClayBoundaryLock_solved",
    "def AdmissibleClayBoundaryLockTarget",
...
require(
    "import Chronos.Frontier.AdmissiblePNPBoundaryLockToClayBoundaryLock" in chronos,
    "missing Chronos.lean import",
)

require(
    artifact["status"] == "ADMISSIBLE_CLAY_BOUNDARY_LOCK_CLOSED_NO_THEOREM_PROMOTION",
...
print("Admissible P vs NP boundary lock to Clay boundary lock verified.")
