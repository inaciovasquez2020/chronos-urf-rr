...
artifact = ROOT / "artifacts/chronos/zero_arity_carrier_obstruction_boundary.json"
doc = ROOT / "docs/status/CHRONOS_ZERO_ARITY_CARRIER_OBSTRUCTION_BOUNDARY_2026_05_09.md"
...
assert "zero-arity admissible predicates" in data["statement"]
assert "formally excluded" in data["statement"]
...
print("ZeroArityCarrierObstruction boundary verified: FRONTIER_OPEN")
