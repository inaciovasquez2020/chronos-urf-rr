...
lean = root / "Chronos/Frontier/FinalCarrierSemanticRankRateCoverage.lean"
doc = root / "docs/status/CHRONOS_FINAL_CARRIER_SEMANTIC_RANK_RATE_COVERAGE_2026_05_13.md"
artifact = root / "artifacts/chronos/final_carrier_semantic_rank_rate_coverage_2026_05_13.json"
chrono = root / "Chronos.lean"

required = {
    lean: [
        "structure FinalCarrierSemanticRankRateCoverage : Prop",
        "structure UniversalFiberEntropyGap : Prop",
    ...
    doc: [
        "Status: `FRONTIER_OPEN / COVERAGE_FRONTIER_ONLY`",
...
if data.get("status") != "FRONTIER_OPEN / COVERAGE_FRONTIER_ONLY":
    raise SystemExit("artifact status mismatch")

if data.get("weakest_missing_object") != "FinalCarrierSemanticRankRateCoverage":
...
print("FinalCarrierSemanticRankRateCoverage frontier verified.")
