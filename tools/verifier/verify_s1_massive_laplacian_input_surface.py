...
required = [
    ...
    "MathlibFTCIBPSideConditions",
    "mathlib_ftc_ibp_side_conditions_surface",
    "mathlib_ftc_ibp_identity_from_surface",
    "PR1000_MILESTONE_mathlib_ftc_ibp_identity_executable",
    "pr1000_milestone_mathlib_ftc_ibp_identity_executable",
