...
lean = root / "lean/Chronos/Frontier/DetectorBudgetCompatibleToGate.lean"
artifact = root / "artifacts/chronos/detector_budget_compatible_to_gate_2026_05_28.json"
doc = root / "docs/status/DETECTOR_BUDGET_COMPATIBLE_TO_GATE_2026_05_28.md"
...
if "import Chronos.Frontier.DetectorBudgetCompatibleToGate" not in chronos.read_text():
    raise SystemExit("Chronos.lean missing DetectorBudgetCompatibleToGate import")

data = json.loads(artifact.read_text())
if data.get("status") != "FINITE_COMPATIBILITY_TO_RESTRICTED_GATE_BRIDGE_ONLY":
...
print("DETECTOR_BUDGET_COMPATIBLE_TO_GATE_OK")
