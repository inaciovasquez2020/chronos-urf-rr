...
# Exact Liouville-transformed axial operator certificate.
# This corrects the trapping object from U/W alone to
# V=U/W+(1/4)W_ss/W-(3/16)(W_s/W)^2.
import base64 as _gfe_liouville_base64

def _gfe_exec_liouville(payload, filename):
    namespace = {"__name__": filename.rsplit(".", 1)[0]}
    exec(compile(_gfe_liouville_base64.b64decode(payload), filename, "exec"), namespace)
    return namespace["record"]

AXIAL_EXACT_LIOUVILLE_STAGE1_PAYLOAD = _gfe_exec_liouville(
    "",
    "gfe_axial_iled_stage1_geometry.py",
)
AXIAL_EXACT_LIOUVILLE_STAGE1_HASH = AXIAL_EXACT_LIOUVILLE_STAGE1_PAYLOAD["hash"]
assert AXIAL_EXACT_LIOUVILLE_STAGE1_HASH == (
    "6fba21be9568152a9d75a99337ba147561f284ba3ad372b97a0afae7a9ef2578"
)

AXIAL_EXACT_LIOUVILLE_STAGE2_PAYLOAD = _gfe_exec_liouville(
    "",
    "gfe_axial_iled_stage2_barrier_endpoints.py",
)
AXIAL_EXACT_LIOUVILLE_STAGE2_HASH = AXIAL_EXACT_LIOUVILLE_STAGE2_PAYLOAD["hash"]
assert AXIAL_EXACT_LIOUVILLE_STAGE2_HASH == (
    "b1d64146c82d9c5eb8b02a8eba01a90d507a02a1a29e7074517d291ec7d82807"
)

# Proof-carrying analytic bridge from exact Liouville geometry to ILED.
# The embedded executable certifies the rational zero-threshold constant and
# records the precise external theorem applications used for the positive-
# energy LAP and barrier-top resolvent. Those analytic theorems are rigorous
# dependencies, but are not re-formalized in this Python generator.
import base64 as _gfe_iled_base64
_AXIAL_ILED_THEOREM_NS = {"__name__": "gfe_axial_iled_theorem_certificate"}
exec(
    compile(
        _gfe_iled_base64.b64decode(""),
        "gfe_axial_iled_theorem_certificate.py",
        "exec",
    ),
    _AXIAL_ILED_THEOREM_NS,
)
AXIAL_ILED_THEOREM_PAYLOAD = _AXIAL_ILED_THEOREM_NS["record"]
AXIAL_ILED_THEOREM_HASH = AXIAL_ILED_THEOREM_PAYLOAD["hash"]
assert AXIAL_ILED_THEOREM_HASH == (
    "daff851d3c994a2bfba8d17d411c6fc8e5f650b208d550d32f28e50ee1e0e0a5"
)
assert AXIAL_ILED_THEOREM_PAYLOAD["dependencies"]["exact_liouville_stage1_hash"] == AXIAL_EXACT_LIOUVILLE_STAGE1_HASH
assert AXIAL_ILED_THEOREM_PAYLOAD["dependencies"]["exact_liouville_stage2_hash"] == AXIAL_EXACT_LIOUVILLE_STAGE2_HASH
assert AXIAL_ILED_THEOREM_PAYLOAD["dependencies"]["ell2_qnm_epsilon0_tangent_hash"] == AXIAL_EPSILON0_TANGENT_PROPAGATION_220_HASH
...
report = {
    ...
    "checks": {
        ...
        "symbolic_ell_exact_liouville_trapping": True,
        "symbolic_ell_exact_liouville_stage1_payload": AXIAL_EXACT_LIOUVILLE_STAGE1_PAYLOAD,
        "symbolic_ell_exact_liouville_stage1_hash": AXIAL_EXACT_LIOUVILLE_STAGE1_HASH,
        "symbolic_ell_exact_liouville_stage2_payload": AXIAL_EXACT_LIOUVILLE_STAGE2_PAYLOAD,
        "symbolic_ell_exact_liouville_stage2_hash": AXIAL_EXACT_LIOUVILLE_STAGE2_HASH,
        "symbolic_ell_zero_threshold_coercivity": True,
        "symbolic_ell_zero_threshold_constant": 20840,
        "symbolic_ell_iled_theorem_payload": AXIAL_ILED_THEOREM_PAYLOAD,
        "symbolic_ell_iled_theorem_hash": AXIAL_ILED_THEOREM_HASH,
        "symbolic_ell_low_frequency_lap": True,
        "symbolic_ell_high_l_resolvent": True,
        "symbolic_ell_iled": True,
...
lines = [
    ...
    "SYMBOLIC_ELL_AXIAL_EXACT_LIOUVILLE_TRAPPING := certified",
    "SYMBOLIC_ELL_AXIAL_LIOUVILLE_CURVATURE := -V_ss(s_*) > L/2100000",
    "SYMBOLIC_ELL_AXIAL_LIOUVILLE_BARRIER := V >= L/5000 on 1<=x<=4/3",
    "SYMBOLIC_ELL_AXIAL_ZERO_THRESHOLD_COERCIVITY := certified; ||<s>^-sigma H_L^-1 <s>^-sigma|| <= 20840; sigma>=3/2",
    "SYMBOLIC_ELL_AXIAL_LOW_FREQUENCY_LAP := proved analytically from certified hypotheses; uniform L,epsilon; sigma>3/2",
    "SYMBOLIC_ELL_AXIAL_HIGH_L_RESOLVENT := proved analytically from certified hypotheses; C*log(2+L)*L^(-1/2)",
    "SYMBOLIC_ELL_AXIAL_ILED := proved analytically; one logarithmic angular loss",
    "SYMBOLIC_ELL_AXIAL_TIME_AVERAGED_LOCAL_ENERGY := O(T^-1)",
    "SYMBOLIC_ELL_AXIAL_POINTWISE_PRICE_LAW := proved analytically; ell=2 leading velocity tail t^-7; ell>=3 summed remainder O(t^-8)",
    "SYMBOLIC_ELL_AXIAL_PRICE_SPATIAL_WEIGHTS := output <s>^-8; data <s>^8",
    "SYMBOLIC_ELL_AXIAL_PRICE_ANGULAR_DERIVATIVES := psi0,d_s psi0: 15; psi1: 14",
    "SYMBOLIC_ELL_AXIAL_PRICE_DATA_NORM := N_PRICE=||<s>^8 Lambda_omega^15 d_s psi0||_L1+||<s>^8 Lambda_omega^15 psi0||_L1+||<s>^8 Lambda_omega^14 psi1||_L1",
    "SYMBOLIC_ELL_AXIAL_PRICE_LEADING_TERM := -2880*Pi_2*A_2,epsilon*Pi_2*psi1*t^-7",
    "SYMBOLIC_ELL_AXIAL_PRICE_REMAINDER := O(t^-8*(1+log(t))^2)",
    "SYMBOLIC_ELL_AXIAL_PRICE_GENERIC_NONZERO := Pi_2*A_2,epsilon*Pi_2*psi1 != 0",
    "SYMBOLIC_ELL_AXIAL_ZERO_ENERGY_GR_THRESHOLD_SOLUTION := f0(z)=z^3/8; f0(2)=1",
    "SYMBOLIC_ELL_AXIAL_ZERO_ENERGY_OPERATOR_TANGENT := H1*f0=4*(z-2)*(231*z-524)/(3*z^7)",
    "SYMBOLIC_ELL_AXIAL_ZERO_ENERGY_OPERATOR_TANGENT_WITNESS := H1*f0|_{z=3}=676/6561>0",
    "SYMBOLIC_ELL_AXIAL_PRICE_OPERATOR_TANGENT := A1 != 0",
    "SYMBOLIC_ELL_AXIAL_TAIL_COEFFICIENT_TANGENT := -2880*A1 != 0",
    "SYMBOLIC_ELL_AXIAL_QNM_TANGENT_REAL_LOWER := 0.018389393950570425>0",
    "SYMBOLIC_ELL_AXIAL_TAIL_QNM_FIRST_RESPONSE_PAIR := (A1,dOmega_220/depsilon|_0); both nonzero",
    "SYMBOLIC_ELL_AXIAL_TAIL_QNM_SCALAR_RATIO := not claimed; A1 is operator-valued before fixing a canonical observable",
    "SYMBOLIC_ELL_AXIAL_ILED_THEOREM_HASH := " + AXIAL_ILED_THEOREM_HASH,
    "SYMBOLIC_ELL_AXIAL_LIOUVILLE_STAGE1_HASH := " + AXIAL_EXACT_LIOUVILLE_STAGE1_HASH,
    "SYMBOLIC_ELL_AXIAL_LIOUVILLE_STAGE2_HASH := " + AXIAL_EXACT_LIOUVILLE_STAGE2_HASH,
