...
lines = [
    ...
    "SYMBOLIC_ELL_AXIAL_LOW_FREQUENCY_LAP := open; uniform threshold resolvent not yet certified",
    "SYMBOLIC_ELL_AXIAL_HIGH_L_RESOLVENT := open; barrier-top commutator remainder not yet certified",
    "SYMBOLIC_ELL_AXIAL_ILED := not yet proved",
