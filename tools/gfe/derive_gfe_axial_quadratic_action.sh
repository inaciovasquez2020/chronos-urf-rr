...
assert AXIAL_ILED_THEOREM_HASH == (
    "38ad2af99d4551cb03e2b72a2cef391997356e8d539bc58a8f1a38f93066be96"
)
...
lines = [
    ...
    "SYMBOLIC_ELL_AXIAL_POINTWISE_PRICE_LAW := not claimed",
